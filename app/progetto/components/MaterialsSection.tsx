    ...
    <section ref={containerRef} id="materiali" className="relative h-[1200vh] bg-black">
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-20 w-full max-w-6xl px-6 md:px-16 mx-auto h-full flex items-center">
          ...
          <motion.div style={{ opacity: txt1Op, y: txtY }} className="absolute w-4/5 md:max-w-2xl left-5 md:left-16 text-white">
          ...
          {/* TESTO 02: RESISTENZA */}
          <motion.div style={{ opacity: txt2Op, y: txtY }} className="absolute w-4/5 md:max-w-2xl left-5 md:left-16 text-white">
          ...
          {/* TESTO 03: LEGGEREZZA */}
          <motion.div style={{ opacity: txt3Op, y: txtY }} className="absolute w-4/5 md:max-w-2xl left-5 md:left-16 text-white">
          ...
          {/* TESTO 04: MECCANISMO */}
          <motion.div style={{ opacity: txt4Op, y: txtY }} className="absolute w-4/5 md:max-w-2xl left-5 md:left-16 text-white">
          ...
          {/* TESTO 05: SUPERFICI */}
          <motion.div style={{ opacity: txt5Op, y: txtY }} className="absolute w-4/5 md:max-w-2xl left-5 md:left-16 text-white">
