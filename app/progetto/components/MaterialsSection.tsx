// app/progetto/components/MaterialsSection.tsx
"use client";
...
export default function MaterialsSection() {
  ...
  // 4. TIMELINE DEI TESTI (Invariata)
    ...
    <section ref={containerRef} id="materiali" className="relative h-[1200vh] bg-black">
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-20 w-full max-w-6xl px-6 md:px-16 mx-auto h-full flex items-center">
          ...
          {/* TESTO 01: COPERTURA */}
          {/* MODIFICA: max-w-lg cambiato in max-w-2xl per allargare la gabbia */}
          <motion.div style={{ opacity: txt1Op, y: txtY }} className="absolute max-w-2xl left-6 md:left-16 text-white">
          ...
          {/* TESTO 02: RESISTENZA */}
          <motion.div style={{ opacity: txt2Op, y: txtY }} className="absolute max-w-2xl right-6 md:right-16 text-white text-left md:text-left">
            <p className="font-mono text-white tracking-[0.2em] text-sm font-bold uppercase mb-4 drop-shadow-md">02. Resistenza</p>
            <h3 className="font-heading font-bold text-4xl md:text-5xl text-white text-left mb-8">Lamiera in Alluminio</h3>
            <p className="font-sans text-sm md:text-base leading-relaxed text-white/80 drop-shadow-lg text-left w-full">
          ...
          {/* TESTO 03: LEGGEREZZA */}
          <motion.div style={{ opacity: txt3Op, y: txtY }} className="absolute max-w-2xl left-6 md:left-16 text-white">
            <p className="font-mono text-white tracking-[0.2em] text-sm font-bold uppercase mb-4 drop-shadow-md">03. Leggerezza</p>
            <h3 className="font-heading font-bold text-4xl md:text-5xl text-white text-left mb-8">Alluminio Anodizzato</h3>
            <p className="font-sans text-sm md:text-base leading-relaxed text-white/80 drop-shadow-lg text-left w-full">
          ...
          {/* TESTO 04: MECCANISMO */}
          <motion.div style={{ opacity: txt4Op, y: txtY }} className="absolute max-w-2xl right-6 md:right-16 text-white text-left md:text-left">
            <p className="font-mono text-white tracking-[0.2em] text-sm font-bold uppercase mb-4 drop-shadow-md">04. Meccanismo</p>
            <h3 className="font-heading font-bold text-4xl md:text-5xl text-white text-left mb-8">Acciaio Inox</h3>
            <p className="font-sans text-sm md:text-base leading-relaxed text-white/80 drop-shadow-lg text-left w-full">
          ...
          {/* TESTO 05: SUPERFICI */}
          <motion.div style={{ opacity: txt5Op, y: txtY }} className="absolute max-w-2xl left-6 md:left-16 text-white">
